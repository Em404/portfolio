...
export const Projects = () => {
  ...
  return (
    <Fragment>
      <div className='container mx-auto px-8 md:px-32 lg:px-48 pt-24'>
        <motion.h2
            ...
            className='text-xl md:text-2xl lg:text-3xl font-bold text-center lg:text-left text-purple-600 dark:text-neutral-50 mb-8 md:mb-16'>Projects</motion.h2>
                ...
                projects.map((project, index) => {
                  return (
                    <motion.div
                      ...
                      custom={index}
                      key={index} className='flex flex-col items-center py-4 px-4 dark:bg-neutral-800 bg-purple-600 rounded-3xl text-neutral-50 custom-box-shadow'>
                      ...
                      <div className='flex flex-wrap justify-center mt-4'>
                        {
                          project.tags.map((tag, index) => {
                            return (
                              <span key={index} className='dark:bg-purple-600 bg-neutral-50 text-purple-600 dark:text-neutral-50 font-semibold rounded-3xl px-2 me-2 mb-2'>{tag}</span>
                            )
                          })
                        }
                      </div>
