...
export const Home = ({ clickedLink, setcliCkedLink }) => {
  ...
  return (
    <Fragment>
      ...
      <div
        ref={homeRef}
        className="bg-neutral-50 text-neutral-800 dark:bg-neutral-800 dark:text-neutral-50 pt-20 md:pt-20 lg:pt-24 xl:pt-28 h-screen h-custom flex items-center"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            >
              ...
              <div className="mb-16 md:mb-8 lg:mb-16 flex flex-col justify-center lg:justify-start">
                <button
                  className="bg-purple-600 text-neutral-50 rounded-xl text-lg md:text-xl py-2 px-4 hover:scale-110 duration-300 mb-4 md:mx-32 lg:ms-0 lg:me-32"
                  ref={contactsRef}
                  id="contatti"
                >
              ...
              <div className="flex justify-center lg:justify-start">
                <a
                  ...
                  className="me-4 hover:scale-125 duration-300"
                >
                  <svg
