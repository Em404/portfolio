        ...
        <div className='container mx-auto px-8 md:px-32 lg:px-48'>
          <div className='grid grid-cols-1 lg:grid-cols-2'>
            <motion.div
              ...
              <div className='mb-16 flex flex-col justify-center lg:justify-start'>
               <button className='bg-purple-900 text-neutral-100 rounded-lg md:text-2xl py-2 px-4 hover:scale-110 duration-300 mb-4 md:mx-32 lg:ms-0 lg:me-32' ref={contattiRef} id="contatti">
                 <Link to='/contatti'>Contattami!</Link>
               </button>
               <button className='bg-purple-900 text-neutral-100 rounded-lg md:text-2xl py-2 px-4 hover:scale-110 duration-300 md:mx-32 lg:ms-0 lg:me-32' ref={contattiRef} id="contatti">
